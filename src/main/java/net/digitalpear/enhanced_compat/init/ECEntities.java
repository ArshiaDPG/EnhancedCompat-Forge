...
public class ECEntities {
    ...
    public static final Supplier<PollinatedBoatType> TOADSTOOL_BOAT = BOATS.register("toadstool_boat", () -> new PollinatedBoatType(new ResourceLocation(EnhancedCompatMod.MOD_ID, "textures/entity/boat/toadstool_boat.png")));
