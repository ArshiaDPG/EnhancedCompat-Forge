...
@Mixin(SmallGlowshroomFeature.class)
public class SmallGlowshroomFeatureMixin extends Feature<NoneFeatureConfiguration> {
    private static final Block GLOWSHROOM_STEM = ECBlocks.GLOWSHROOM_STEM.get();

    public SmallGlowshroomFeatureMixin(Codec<NoneFeatureConfiguration> p_65786_) {
        super(p_65786_);
    }
