...
public class MediumGlowshroomFeatureOverride extends Feature<NoneFeatureConfiguration> {
    ...
    public MediumGlowshroomFeatureOverride(Codec<NoneFeatureConfiguration> p_65786_) {
        super(p_65786_);
    }
